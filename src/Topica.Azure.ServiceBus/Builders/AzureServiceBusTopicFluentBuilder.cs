...
public class AzureServiceBusTopicFluentBuilder(ITopicProviderFactory topicProviderFactory, IServiceBusClientProvider provider, ILogger<AzureServiceBusTopicFluentBuilder> logger) : IAzureServiceBusTopicFluentBuilder, IAzureServiceBusTopicBuilderWithTopicName, IAzureServiceBusTopicBuilderWithSubscriptions, IAzureServiceBusTopicBuilder
{
    ...
    public IAzureServiceBusTopicBuilder WithSubscriptions(params AzureServiceBusTopicSubscriptionSettings[] subscriptions)
    {
    ...
    public async Task<IConsumer> BuildConsumerAsync(string subscribeToSubscription, int? numberOfInstances, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogInformation("***** Connecting {MessagingPlatform} for consumer: {Name} to Source: {MessagingSettings}", MessagingPlatform.AzureServiceBus, _workerName, messagingSettings.Source);
    ...
    public async Task<IProducer> BuildProducerAsync(CancellationToken cancellationToken)
    {
        ...
        logger.LogInformation("***** Connecting {MessagingPlatform} for producer: {Name} to Source: {MessagingSettings}", MessagingPlatform.AzureServiceBus, _workerName, messagingSettings.Source);

    ...
    : IAzureServiceBusQueueCreationBuilder, IAzureServiceBusQueueCreationBuilderWithQueueName, IAzureServiceBusQueueCreationBuilderWithBuild
{
    ...
    public IAzureServiceBusQueueCreationBuilderWithQueueName WithWorkerName(string workerName)
    {
        _workerName = workerName;
        return this;
    }
    
    public IAzureServiceBusQueueCreationBuilderWithBuild WithQueueName(string queueName)
    {
    ...
    public IAzureServiceBusQueueCreationBuilderWithBuild WithOptions(
    ...
    public IAzureServiceBusQueueCreationBuilderWithBuild WithMetadata(string? metadata)
    {
        _metadata = metadata;
        return this;
    }

    public IAzureServiceBusQueueCreationBuilderWithBuild WithNumberOfInstances(int? numberOfInstances)
    {

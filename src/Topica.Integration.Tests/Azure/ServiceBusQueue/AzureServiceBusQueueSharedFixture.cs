...
public class AzureServiceBusQueueSharedFixture : IAsyncLifetime
{
    ...
    public IAzureServiceBusQueueCreationBuilder Builder { get; private set; } = null!;
    ...
    public async Task InitializeAsync()
    {
        ...
        var configFilePath = Path.Join(currentDomainBaseDirectory, "Azure", "ServiceBusQueue", "AzureServiceBusConfig.json");
        ...
        Host.CreateDefaultBuilder()
            .ConfigureServices((ctx, services) =>
            {
                ...
                Builder = services.BuildServiceProvider().GetRequiredService<IAzureServiceBusQueueCreationBuilder>();
            }).Build();
    }

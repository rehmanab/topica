...
namespace Aws.Messaging.Queue
{
    public class QueueProvider : IQueueProvider
    {
        ...
        public QueueProvider(IAmazonSQS client, IQueueCreationFactory queueCreationFactory, ISqsConfigurationBuilder sqsConfigurationBuilder, ILogger<QueueProvider> logger)
        {
            _client = client;

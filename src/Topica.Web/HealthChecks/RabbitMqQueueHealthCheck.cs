...
public class RabbitMqQueueHealthCheck(IRabbitMqManagementApiClient managementApiClient, ConnectionFactory rabbitMqConnectionFactory, IWebHostEnvironment env) : IHealthCheck
{

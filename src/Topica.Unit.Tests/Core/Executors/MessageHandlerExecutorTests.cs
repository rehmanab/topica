...
public class MessageHandlerExecutorTests
{
    ...
    {
        _handlerResolver.ResolveHandler("", new Dictionary<string, string>()) .Returns((false, new object(), false, null));
    ...
    {
        _handlerResolver.ResolveHandler("", new Dictionary<string, string>()) .Returns((true, new object(), false, null));
